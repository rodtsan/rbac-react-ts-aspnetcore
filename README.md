...
* [Redux](https://redux.js.org/) - A Predictable State Container for JS Apps. 
   - The project are using additional libraries for Redux implementations such as [React Redux](https://react-redux.js.org/), and [Redux Toolkit](https://redux-toolkit.js.org/).
