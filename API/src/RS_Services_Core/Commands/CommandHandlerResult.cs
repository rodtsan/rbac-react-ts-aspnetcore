...
namespace RS_Services_Core.Commands
{
	public class CommandHandlerResult
	{
		...
		public static CommandHandlerResult RequestTimeout(string error)
		{
			return InvalidResult(HttpStatusCode.RequestTimeout, error);
		}
		...
		public static CommandHandlerResult RecordNotFound(string error)
		{
			return InvalidResult(HttpStatusCode.NotFound, error);
		}
		...
		{
			return new CommandHandlerResult(code, error);
		}
